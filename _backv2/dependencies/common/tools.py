class Vector:
    ...
    def __eq__(self, other): # Defines what it means to be equal to a 'Vector'
        ...
        elif t == tuple and len(other) == 2: # if other is a tuple with two elems, like (x, y) then compare those two
            return self.x == other[0] and self.y == other[1]
        elif t == list and len(other) == 2: # same as tuple comparision
            return self.x == other[0] and self.y == other[1]
    ...
    def __add__(self,other):
        ...
        elif t == tuple and len(other) == 2:
            return Vector(self.x + other[0], self.y + other[1])
        elif t == list and len(other) == 2:
            return Vector(self.x + other[0], self.y + other[1])
        else:
